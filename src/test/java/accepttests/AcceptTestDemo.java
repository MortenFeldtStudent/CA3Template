...
public class AcceptTestDemo {
    ...
    private static final String APP_CONTEXT = "/CA3Template";  //IMPORTANT--> this should reflect the value in META-INF/context.xml
    ...
    public static void setUpBeforeAll() throws LifecycleException, ServletException, MalformedURLException {
        RestAssured.baseURI = "https://www.mortenfeldtstudent.dk/";
        //RestAssured.port = 80;
